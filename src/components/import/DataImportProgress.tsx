...
export const DataImportProgress = ({
	data,
	mapping,
	onCompleted,
}: DataImportProgressProps) => {
			...
			try {
				...
				const result = await importPatients(data, mapping, {
					onProgress: (processed, total) => {
						...
						setCurrentStatus(
							`Import en cours... ${processed}/${total} patients traités`,
						);
					},
				});
					...
					<div className="p-4 bg-blue-50 dark:bg-blue-950/30 border border-blue-200 dark:border-blue-800 rounded-lg">
						<div className="flex items-start gap-2">
							...
							<div className="text-sm text-blue-800 dark:text-blue-200">
								...
								<p>
									Veuillez ne pas fermer cette page pendant
									l'import. Un rapport détaillé sera généré à
									la fin du processus.
								</p>
							</div>
						</div>
