  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Téléchargez vos statistiques et données comptables au format Excel ou PDF
        </CardDescription>
      </CardHeader>
      <CardContent className="space-y-4">
        ...
        <p className="text-xs text-muted-foreground mt-2">
          Les exports incluent votre logo et signature si configurés dans vos paramètres
        </p>
      </CardContent>
    </Card>
  );
