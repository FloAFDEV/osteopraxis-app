...
export const InvoiceFilters = (props: InvoiceFiltersProps) => {
	...
	const formatMonthDisplay = (monthKey: string): string => {
		try {
			...
			console.error(
				`Error formatting month display for ${monthKey}:`,
				error,
			);
			return monthKey;
		}
			...
			<CardContent className="p-4">
				...
				<div className="flex flex-wrap gap-4 mb-4">
					<div>
						...
						<Select
							value={
								props.selectedOsteopathId != null
									? String(props.selectedOsteopathId)
									: ""
							}
							onValueChange={(v) => {
								// ✅ Sélection ostéopathe
								props.setSelectedOsteopathId(
									v === "ALL" || v === "" ? null : Number(v),
								);
							}}
						>
					...
					<div>
						...
						<Select
							value={
								props.selectedCabinetId != null
									? String(props.selectedCabinetId)
									: ""
							}
							onValueChange={(v) => {
								// ✅ Sélection cabinet
								props.setSelectedCabinetId(
									v === "ALL" || v === "" ? null : Number(v),
								);
							}}
						>
