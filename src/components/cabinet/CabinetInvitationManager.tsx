...
import {
	CabinetInvitation,
	cabinetInvitationService,
} from "@/services/supabase-api/cabinet-invitation-service";
import {
	Check,
	Clock,
	Copy,
...
export function CabinetInvitationManager({
	cabinetId,
	cabinetName,
}: CabinetInvitationManagerProps) {
	...
	const handleCopyCode = (code: string) => {
		...
		toast.success("Code d'invitation copié", {
			description:
				"L'ostéopathe peut utiliser ce code lors de son inscription",
		});
	};
			...
			<div className="flex justify-between items-start">
				<div>
					<div className="flex items-center gap-2">
						...
						<HelpButton content="Système d'invitations sécurisé pour votre cabinet d'ostéopathie. Générez des codes uniques, temporaires et traçables pour inviter des ostéopathes de confiance à rejoindre votre équipe." />
					</div>
					<p className="text-sm text-muted-foreground">
						Gérez les invitations pour rejoindre{" "}
						...
						<div className="space-y-4">
							<Alert className="border-blue-200 bg-blue-50 dark:border-blue-800 dark:bg-blue-900/20">
								...
								<AlertDescription className="text-blue-800 dark:text-blue-300">
									<strong>Sécurisé :</strong> Code unique,
									valide 7 jours, usage unique, traçable
								</AlertDescription>
							</Alert>
			...
			{invitations.length === 0 ? (
				<div className="text-center py-12 bg-muted/50 rounded-lg border-2 border-dashed">
					...
					<p className="text-muted-foreground mb-6 max-w-md mx-auto">
						Créez des invitations sécurisées pour permettre à
						d'autres ostéopathes de rejoindre votre cabinet. Parfait
						pour construire une équipe de confiance.
					</p>
					<Button
