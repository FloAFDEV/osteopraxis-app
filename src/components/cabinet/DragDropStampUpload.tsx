    ...
    <FormField
      ...
      render={({ field }) => (
        <FormItem>
                  ...
                  <CardContent className="p-4">
                    <div className="flex items-center justify-between mb-3">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-sm font-medium">Aperçu du tampon/signature</span>
                      </div>
                      <Button
                        type="button"
                        variant="outline"
                    ...
                    <p className="text-xs text-center mt-2 text-muted-foreground">
                      Cette image sera affichée en bas de chaque note d'honoraires
                    </p>
                  </CardContent>
                </Card>
              )}
          ...
          <FormDescription>
            Uploadez votre tampon ou signature par glisser-déposer ou en cliquant. 
            Format PNG/JPG, max 5MB, hauteur recommandée: 150px.
            Cette image sera utilisée sur vos notes d'honoraires.
          </FormDescription>
          <FormMessage />
        </FormItem>
      )}
