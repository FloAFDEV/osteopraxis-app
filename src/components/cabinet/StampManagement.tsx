    ...
    <FormField
      ...
      render={({ field }) => (
        <FormItem>
                          ...
                          <DialogContent>
                            ...
                            <div
                              ...
                              onDrop={(e) => {
                                ...
                                setDragActive(false);
                                if (e.dataTransfer.files && e.dataTransfer.files[0]) {
                                  uploadStamp(e.dataTransfer.files[0]);
                                }
                              }}
          ...
          <FormDescription>
            Votre tampon ou signature professionnelle sera automatiquement inclus sur vos notes d'honoraires et devis.
            Format recommandé : PNG ou JPG, hauteur max 150px, taille max 5MB.
          </FormDescription>
          <FormMessage />
        </FormItem>
      )}
