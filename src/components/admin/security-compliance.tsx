    ...
    try {
      ...
      const mockAlerts: SecurityAlert[] = [
        ...
        },
        {
          ...
          severity: "medium",
          description: "5 tentatives de connexion échouées en 10 minutes",
        ...
        },
        {
          ...
          type: "data_access",
          severity: "critical",
          description: "Accès non autorisé aux données patients détecté",
      ...
      const complianceData: ComplianceMetric[] = [
        {
          ...
          status: "compliant",
          score: 95,
          description: "Chiffrement AES-256 actif sur toutes les données sensibles",
        ...
        },
        {
          ...
          status: "compliant",
          score: 98,
          description: "RLS activé et politiques configurées correctement",
          last_check: new Date().toISOString()
        },
        {
        ...
        },
        {
          ...
          status: "compliant",
          score: 92,
          description: "Sauvegardes automatiques quotidiennes actives",
          last_check: new Date().toISOString()
        },
        {
        ...
        },
        {
          ...
          status: "compliant",
          score: 88,
          description: "Détection d'intrusion active et monitoring en temps réel",
          last_check: new Date().toISOString()
        }
      ];
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        ...
        <div className="flex items-center gap-2">
          ...
          <span className="font-medium">Score Global: {overallComplianceScore}%</span>
        </div>
      </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
              ...
              <Card>
                ...
                <CardContent>
                  <div className="flex justify-between items-center">
                    <div className="text-2xl font-bold text-red-600">
                      {securityAlerts.filter(a => a.severity === "critical" && !a.resolved).length}
                    </div>
              ...
              <Card>
                <CardHeader className="pb-2">
                  <CardTitle className="text-sm font-medium text-muted-foreground">Résolues Aujourd'hui</CardTitle>
                </CardHeader>
                <CardContent>
                  <div className="flex justify-between items-center">
              ...
              <Card>
                <CardHeader className="pb-2">
                  <CardTitle className="text-sm font-medium text-muted-foreground">Score Sécurité</CardTitle>
                </CardHeader>
                <CardContent>
                  <div className="flex justify-between items-center">
                    <div className="text-2xl font-bold text-blue-600">{overallComplianceScore}%</div>
            ...
            <Card>
              ...
              <CardContent>
                <div className="flex items-center justify-between">
                  <div>
                    <div className="text-4xl font-bold text-green-600">{overallComplianceScore}%</div>
                    <p className="text-muted-foreground">Niveau de conformité HDS</p>
                  </div>
                ...
                <div className="space-y-3">
                  <div className="flex items-center gap-3 p-3 bg-yellow-50 rounded-lg">
                    ...
                    <div className="flex-1">
                      <p className="font-medium">Améliorer la rétention des logs</p>
                      <p className="text-sm text-muted-foreground">
                        Configurer une rétention de 3 ans pour les logs d'audit
                      </p>
                    </div>
                  ...
                  <div className="flex items-center gap-3 p-3 bg-blue-50 rounded-lg">
                    ...
                    <div className="flex-1">
                      <p className="font-medium">Activer l'authentification forte</p>
                      <p className="text-sm text-muted-foreground">
                        Imposer le 2FA pour tous les comptes administrateurs
                      </p>
                    </div>
          ...
          <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                  <div className="p-4 border rounded-lg">
                    ...
                    <p className="text-sm text-muted-foreground mb-3">
                      Accès complet au système et aux données
                    </p>
                    <div className="flex justify-between items-center">
                  ...
                  <div className="p-4 border rounded-lg">
                    <h4 className="font-medium mb-2">Ostéopathes</h4>
                    <p className="text-sm text-muted-foreground mb-3">
                      Accès aux patients et rendez-vous
                    </p>
                    <div className="flex justify-between items-center">
                      <Badge variant="outline">456 utilisateurs</Badge>
                      <Button size="sm" variant="outline">
                        <Eye className="h-4 w-4 mr-1" />
                        Voir
                      </Button>
                  ...
                  <div className="p-4 border rounded-lg">
                    ...
                    <div className="flex justify-between items-center">
                      <Badge variant="outline">89 sessions</Badge>
                      <Button size="sm" variant="outline">
            ...
            <Card>
              ...
              <CardContent>
                <div className="space-y-4">
                  {[
                    { policy: "RLS (Row Level Security)", status: "Actif", description: "Isolation des données par utilisateur" },
                    { policy: "Authentification forte", status: "Partiel", description: "2FA recommandé pour les admins" },
                    { policy: "Chiffrement des données", status: "Actif", description: "AES-256 en transit et au repos" },
                    { policy: "Monitoring des accès", status: "Actif", description: "Surveillance en temps réel" },
                    { policy: "Sauvegarde sécurisée", status: "Actif", description: "Backups quotidiens chiffrés" }
                  ].map((policy, index) => (
                    <div key={index} className="flex items-center justify-between p-3 border rounded-lg">
                      ...
                      <Badge variant={policy.status === "Actif" ? "default" : "secondary"}>
                        {policy.status}
                      </Badge>
                    </div>
                  ))}
