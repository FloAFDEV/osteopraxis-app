...
export function ProactiveUserManagement() {
	...
	const sendReactivationCampaign = async () => {
		...
		try {
			...
			toast.success(
				`Campagne envoyée à ${selectedUsers.length} utilisateur(s)`,
			);
			setSelectedUsers([]);
			setMessageSubject("");
			setMessageText("");
				...
				<TabsContent value="limitations">
					<div className="space-y-6">
						<Card>
							<CardHeader>
								<CardTitle>
									Limitations par Plan d'Abonnement
								</CardTitle>
							</CardHeader>
							<CardContent>
								...
								<div className="space-y-4">
									<div className="flex items-center justify-between p-3 bg-yellow-50 rounded-lg">
										<div>
											...
											<p className="text-sm text-muted-foreground">
												12 utilisateurs ont atteint 80%
												de leurs limites
											</p>
										</div>
									...
									<div className="flex items-center justify-between p-3 bg-red-50 rounded-lg">
										<div>
											<p className="font-medium">
												Utilisateurs ayant dépassé les
												limites
											</p>
											<p className="text-sm text-muted-foreground">
												3 utilisateurs ont dépassé leurs
												quotas
											</p>
										</div>
										<Button size="sm" variant="outline">
