          ...
          <CardTitle className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <Badge variant={diagnostic.mode === 'demo' ? 'secondary' : 'default'}>
                {diagnostic.mode === 'demo' ? 'Mode Démo' : 'Mode Connecté'}
              </Badge>
            </div>
      ...
      <Tabs defaultValue="services" className="w-full">
        ...
        <TabsContent value="classification" className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <Card>
              <CardHeader>
                <CardTitle className="text-red-600">🔴 Données HDS (Sensibles)</CardTitle>
              </CardHeader>
              <CardContent>
                <div className="space-y-3">
            ...
            <Card>
              <CardHeader>
                <CardTitle className="text-green-600">🟢 Données Non-HDS</CardTitle>
              </CardHeader>
              <CardContent>
                <div className="space-y-3">
                  <p className="text-sm text-gray-600">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    ...
                    <div className="text-sm space-y-1">
                      <p>• Activé: {HDS_SECURITY_CONFIG.encryption.enabled ? '✅' : '❌'}</p>
                      <p>• Algorithme: {HDS_SECURITY_CONFIG.encryption.algorithm}</p>
                      <p>• Dérivation: {HDS_SECURITY_CONFIG.encryption.keyDerivation}</p>
                    </div>
                  </div>
                  <div className="space-y-2">
                    <h4 className="font-medium">Accès</h4>
                    <div className="text-sm space-y-1">
                      <p>• Local uniquement: {HDS_SECURITY_CONFIG.access.localOnly ? '✅' : '❌'}</p>
                      <p>• Pas de sync cloud: {HDS_SECURITY_CONFIG.access.noCloudSync ? '✅' : '❌'}</p>
                      <p>• Auth requise: {HDS_SECURITY_CONFIG.access.requiresAuthentication ? '✅' : '❌'}</p>
                    </div>
                  </div>
                </div>
              </div>
