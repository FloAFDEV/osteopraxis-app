...
export function BusinessAnalytics() {
	...
	const loadBusinessData = async () => {
		try {
			...
			const premiumUsers = activeSubscribers.filter(
				(s) => s.subscription_tier === "Premium",
			);
			const enterpriseUsers = activeSubscribers.filter(
				(s) => s.subscription_tier === "Entreprise",
			);

			const mrr =
				premiumUsers.length * 29.99 + enterpriseUsers.length * 99.99;
			const arr = mrr * 12;
					...
					<div className="space-y-6">
						<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
							...
							<Card>
								...
								<CardContent>
									<div className="text-2xl font-bold">
										{usageMetrics.monthlyActiveUsers}
									</div>
									<p className="text-sm text-muted-foreground mt-1">
							...
							<Card>
								...
								<CardContent>
									<div className="text-2xl font-bold">
										{usageMetrics.sessionDuration.toFixed(
											1,
										)}
										m
									</div>
							...
							<Card>
								...
								<CardContent>
									<div className="text-2xl font-bold">
										{usageMetrics.pagesPerSession.toFixed(
											1,
										)}
									</div>
									<p className="text-sm text-muted-foreground mt-1">
							...
							<Card>
								...
								<CardContent>
									<div className="text-2xl font-bold text-orange-600">
										{usageMetrics.bounceRate.toFixed(1)}%
									</div>
									<p className="text-sm text-muted-foreground mt-1">
										Sessions courtes
									</p>
											...
											(country, index) => (
												...
												>
													<div className="flex items-center gap-3">
														<div className="w-8 h-6 bg-gray-200 rounded flex items-center justify-center text-sm">
															{country.country
																.slice(0, 2)
																.toUpperCase()}
														</div>
								...
								<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
									<div className="p-4 border rounded-lg">
										...
										<p className="text-sm text-muted-foreground mb-3">
											MRR, ARR, LTV, CAC et métriques de
											revenus
										</p>
										<Button
											size="sm"
									...
									<div className="p-4 border rounded-lg">
										...
										<p className="text-sm text-muted-foreground mb-3">
											DAU, MAU, engagement et comportement
											utilisateurs
										</p>
										<Button
											size="sm"
									...
									<div className="p-4 border rounded-lg">
										...
										<p className="text-sm text-muted-foreground mb-3">
											Répartition géographique et revenus
											par région
										</p>
										<Button
											size="sm"
									...
									<div className="p-4 border rounded-lg">
										...
										<p className="text-sm text-muted-foreground mb-3">
											Export complet des données pour
											analyse
										</p>
										<Button
											size="sm"
