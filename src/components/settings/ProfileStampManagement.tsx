			...
			{currentStampUrl ? (
				<Card>
							...
							<div className="flex gap-2">
								...
								>
									...
									<DialogContent>
										<DialogHeader>
											<DialogTitle>
												Supprimer le tampon/signature
											</DialogTitle>
											<DialogDescription>
												Êtes-vous sûr de vouloir
												supprimer définitivement votre
												tampon/signature ? Cette action
					...
					<CardContent>
						...
						<p className="text-sm text-center mt-2 text-muted-foreground">
							Cette image sera affichée sur vos notes d'honoraires
							et devis
						</p>
					</CardContent>
				</Card>
				...
				<div
					...
					onClick={() =>
						!isSubmitting &&
						!uploading &&
						document.getElementById("initial-stamp-input")?.click()
					}
				>
					<div className="flex flex-col items-center justify-center text-center space-y-3">
						...
						<div className="space-y-1">
							...
							<p className="text-sm text-muted-foreground">
								Glissez votre image ici ou cliquez pour
								sélectionner
							</p>
							<p className="text-sm text-muted-foreground">
								PNG, JPG jusqu'à 5MB • Hauteur recommandée:
								150px
							</p>
						</div>
					</div>
