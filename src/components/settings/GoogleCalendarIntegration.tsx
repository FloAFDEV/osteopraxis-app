...
export function GoogleCalendarIntegration() {
	...
	const handleSaveConfig = async () => {
		...
		try {
			...
			toast.info(
				"Configuration sauvegardée. Vous pouvez maintenant connecter Google Calendar.",
			);
	...
	return (
		<Card>
			<CardHeader>
				...
				<CardDescription>
					Synchronisez votre Google Agenda pour afficher vos
					rendez-vous Doctolib dans le planning
				</CardDescription>
			</CardHeader>
				...
				{!isConnected ? (
					<div className="space-y-4">
						<div className="flex items-start gap-3 p-4 bg-blue-50 rounded-lg border border-blue-200">
							...
							<div className="space-y-2 text-sm">
								...
								<ol className="list-decimal list-inside space-y-1 text-blue-800">
									<li>
										Connectez d'abord Doctolib à votre
										Google Agenda depuis votre compte
										Doctolib
									</li>
									<li>
										Configurez vos clés Google API (voir
										guide ci-dessous)
									</li>
									<li>
									...
									<li>
										Autorisez l'accès en lecture à votre
										calendrier
									</li>
									<li>
										Vos rendez-vous Doctolib apparaîtront
						...
						<div className="flex items-start gap-3 p-4 bg-orange-50 rounded-lg border border-orange-200">
							...
							<div className="space-y-2 text-sm">
								...
								<p className="text-orange-800">
									Vous devez d'abord configurer vos propres
									clés API Google. Cette étape est nécessaire
							...
							>
								...
								<DialogContent>
									<DialogHeader>
										...
										<DialogDescription>
											Entrez vos clés API Google Cloud
											pour connecter votre calendrier
										</DialogDescription>
									</DialogHeader>
									<div className="space-y-4">
						...
						<div className="text-sm text-muted-foreground space-y-1">
							...
							<p>
								• Chaque ostéopathe doit configurer ses propres
								clés
							</p>
					...
					<div className="space-y-4">
						...
						<div className="text-sm text-muted-foreground space-y-1">
							...
							<p>
								• Seuls les événements confirmés sont affichés
							</p>
							<p>
								• Les rendez-vous externes sont en lecture seule
							</p>
							<p>
								• Pour facturer : créez manuellement une note
								d'honoraire
							</p>
						</div>
					</div>
