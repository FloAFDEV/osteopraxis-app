...
import { usbImportService, type ImportOptions, type ImportResult, type ImportConflict } from "@/services/secure-usb-sharing/usb-import-service";
  ...
  const handleFileSelect = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (file) {
      if (!file.name.endsWith('.phub')) {
        setErrors(['Veuillez sélectionner un fichier .phub valide']);
        return;
      }
