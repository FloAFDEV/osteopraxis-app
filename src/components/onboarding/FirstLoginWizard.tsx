...
export const FirstLoginWizard: React.FC<FirstLoginWizardProps> = ({
	...
	const [step, setStep] = useState<"welcome" | "storage" | "profile">(
		"welcome",
	);
					...
					{step === "welcome" && (
						<div className="space-y-6">
							...
							<Alert>
								...
								<AlertDescription>
									<strong>
										Configuration en 2 étapes simples :
									</strong>
									<br />
									1. Configuration du stockage sécurisé
									(recommandé)
									<br />
					...
					{step === "storage" && (
						<div className="space-y-6">
							<div className="text-center space-y-4">
								...
								<p className="text-muted-foreground">
									Pour une conformité HDS totale, nous
									recommandons fortement de configurer le
							...
							<Alert>
								...
								<AlertDescription>
									<strong>
										Pourquoi configurer le stockage sécurisé
										?
									</strong>
									<br />• Vos données médicales restent 100%
									sur votre ordinateur
									<br />• Chiffrement AES-256-GCM de niveau
									militaire
									<br />• Conformité HDS garantie
									<br />• Aucune dépendance au cloud pour les
									données sensibles
								</AlertDescription>
							</Alert>
						...
						<div className="space-y-6">
							...
							<Alert>
								...
								<AlertDescription>
									...
									<br />• Partager vos informations avec vos
									patients
								</AlertDescription>
							</Alert>
