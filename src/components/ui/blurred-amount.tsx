  ...
  return (
    <span
      className={cn(
        ...
        isNumbersBlurred && 'blur-sm select-none',
        className
      )}
      title={isNumbersBlurred ? 'Montant masqué pour la confidentialité' : undefined}
    >
      {content}
    </span>
  );
...
export const BlurredNumber: React.FC<BlurredNumberProps> = ({
  ...
  return (
    <span
      ...
      title={isNumbersBlurred ? 'Nombre masqué pour la confidentialité' : undefined}
    >
