		...
		<Card className="fixed bottom-4 right-4 w-80 z-50 shadow-lg">
			...
			<CardContent className="space-y-3 text-sm">
				...
				<div className="flex items-center justify-between">
					...
					<Badge
						variant={
							stats.cacheHitRate > 0.8 ? "default" : "warning"
						}
					>
				...
				<div className="space-y-1">
					<div className="flex items-center justify-between">
						<span>Patients</span>
						<Badge
							variant={loading.patients ? "warning" : "default"}
						>
					...
					<div className="flex items-center justify-between">
						...
						<Badge
							variant={
								loading.appointments ? "warning" : "default"
							}
						>
					...
					<div className="flex items-center justify-between">
						<span>Cabinets</span>
						<Badge
							variant={loading.cabinets ? "warning" : "default"}
						>
