...
export function FullPageLoading({ message = "Chargement...", className }: LoadingStateProps & { message?: string }) {
  return (
...
export const LoadingStates = {
  AppointmentForm: AppointmentFormLoading,
  PatientList: PatientListLoading,
