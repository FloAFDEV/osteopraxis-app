        ...
        <CardContent className="p-4">
          ...
          <div className="space-y-2 text-xs">
            ...
            <div className="space-y-1">
              <div className="flex justify-between">
                <span>Patients:</span>
                <Badge variant={stats.dataFreshness.patients === 'fresh' ? "default" : "outline"}>
              ...
              <div className="flex justify-between">
                ...
                <Badge variant={stats.dataFreshness.appointments === 'fresh' ? "default" : "outline"}>
              ...
              <div className="flex justify-between">
                <span>Cabinets:</span>
                <Badge variant={stats.dataFreshness.cabinets === 'fresh' ? "default" : "outline"}>
            ...
            <div className="flex justify-between">
              <span>Renders:</span>
              <span className="text-muted-foreground">{renderCount}</span>
            </div>
          </div>
