			...
			<div ref={ref} className="bg-white p-8 text-black relative">
				...
				<div className="flex justify-between items-start mb-8 border-b-2 border-gray-200 pb-6">
					...
					<div className="text-right">
						...
						<p className="text-sm text-gray-600">
							Date :{" "}
							{quoteDate
								? format(new Date(quoteDate), "dd MMMM yyyy", {
										locale: fr,
									})
								: "N/A"}
						</p>
				...
				<div className="mt-8 pt-6 border-t border-gray-200">
					...
					<ul className="text-sm text-gray-600 space-y-1">
						...
						<li>
							• Consultations non remboursées par la Sécurité
							Sociale
						</li>
						<li>
							• Possibilité de prise en charge par certaines
							mutuelles
						</li>
					</ul>
				</div>
				...
				<div className="mt-12 flex justify-between items-end">
					<div className="w-1/2">
						<p className="text-sm text-gray-600 mb-4">
							Signature du patient (précédée de "Bon pour accord")
						</p>
				...
				<div className="mt-8 pt-4 border-t border-gray-200">
					...
					<p className="text-sm text-gray-500 text-center mt-1">
						Profession libérale non assujettie à la TVA - Article
						293B du CGI
					</p>
				</div>
			</div>
