			...
			<Card className="w-full sm:w-4/5 md:w-2/3 lg:w-1/2 max-w-2xl border-4 border-red-600 dark:border-red-800">
				...
				<CardContent>
					<p className="text-sm sm:text-base text-gray-600 dark:text-gray-300 mb-4">
						...
						et entraînera la suppression définitive de cette
						facture.
					</p>
					...
					<p className="font-bold text-center mb-4">
						Êtes-vous sûr de vouloir supprimer cette facture de
						manière définitive ?
					</p>
					<div className="text-sm sm:text-sm text-gray-500 dark:text-gray-400">
						<span className="font-semibold">
							Remarque importante :{" "}
						</span>
						La suppression de factures peut entraîner des problèmes
						de comptabilité et n'est généralement pas recommandée.
					</div>
					<ul className="list-disc pl-6 mt-2 text-sm sm:text-sm text-gray-500 dark:text-gray-400">
						<li>
							Les factures doivent être conservées pendant{" "}
							<strong>10 ans</strong> pour des raisons fiscales et
							comptables.
						</li>
						<li>
							Pensez plutôt à marquer la facture comme{" "}
							<strong>annulée</strong> au lieu de la supprimer
							définitivement.
						</li>
					</ul>
				</CardContent>
