			...
			<Card className="w-full sm:w-4/5 md:w-2/3 lg:w-1/2 max-w-2xl h-auto max-h-[90vh] overflow-y-auto border-4 border-red-600 dark:border-red-800">
				...
				<CardContent>
					...
					<p className="font-bold text-center mb-4">
						Êtes-vous sûr de vouloir supprimer ce patient de manière
						définitive ?
					</p>
					<div className="text-sm sm:text-sm text-gray-500 dark:text-gray-400">
						<span className="font-semibold">Remarque : </span>
						certaines données peuvent être nécessaires pour des
						raisons légales, médicales ou administratives.
					</div>
					<ul className="list-disc pl-6 mt-2 text-sm sm:text-sm text-gray-500 dark:text-gray-400">
						<li>
							Les dossiers médicaux doivent être conservés pendant{" "}
							<strong>20 ans</strong> après le dernier contact
							avec le patient.
						</li>
						<li>
							Le{" "}
							...
							permet la conservation des données médicales pour
