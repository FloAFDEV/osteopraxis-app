...
const EmptyPatientState: React.FC<EmptyPatientStateProps> = ({
  ...
  return (
    <div className="text-center py-8 rounded-lg mt-8 bg-gradient-to-br from-[#fafdffee] via-[#eaf4eedd] to-[#f5fafafd] dark:from-[#19272dff] dark:to-[#2e474aff] shadow-sm relative overflow-hidden w-full mx-auto">
