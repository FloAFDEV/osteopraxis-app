...
export function QuoteCreateForm({
	...
	const [currentOsteopathId, setCurrentOsteopathId] = useState<number | null>(
		null,
	);
	...
	return (
		<Card>
			<CardHeader className="flex flex-row items-center justify-between">
				<CardTitle>
					Nouveau devis pour {patient.firstName} {patient.lastName}
				</CardTitle>
				...
				<form onSubmit={handleSubmit} className="space-y-6">
						...
						{osteopathInfo?.stampUrl && (
							<div className="mt-4 pt-4 border-t border-blue-200">
								...
								<p className="text-blue-600 text-sm mt-1">
									Ce tampon/signature sera inclus dans le
									devis. Vous pouvez le modifier dans les
					...
					<div className="bg-amber-50 p-4 rounded-lg border border-amber-200">
						<p className="text-amber-800 text-sm">
							<strong>Important :</strong> Le tampon et la
							signature sont récupérés depuis les paramètres du
							cabinet et seront automatiquement inclus dans le
							devis.
							{!osteopathInfo?.rpps_number &&
								!osteopathInfo?.siret &&
