...
import { Download, Upload, HardDrive, Clock, Shield, AlertTriangle } from "lucide-react";
import {
  exportBackup,
  getLastBackupDate,
      ...
      <CardHeader>
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <CardDescription>
              Exportez vos données locales pour les conserver en sécurité
            </CardDescription>
          </div>
        </div>
      </CardHeader>
      ...
      <CardContent className="space-y-6">
        ...
        <div className="bg-amber-50 dark:bg-amber-950/30 border border-amber-200 dark:border-amber-700 rounded-lg p-4">
          <div className="flex gap-3">
            ...
            <div className="text-sm text-amber-800 dark:text-amber-200">
              ...
              <p>
                Vos données sont stockées localement sur cet appareil. En cas de suppression
                du navigateur, nettoyage des données ou changement d'ordinateur, vos données
                seront perdues si vous n'avez pas effectué de sauvegarde.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                {lastBackupDate
                  ? formatDistanceToNow(lastBackupDate, { addSuffix: true, locale: fr })
                  : "Jamais effectuée"}
              </p>
            </div>
          </div>
        ...
        <div className="flex flex-col sm:flex-row gap-4">
          ...
          >
            ...
            {isExporting ? "Export en cours..." : "Télécharger une sauvegarde"}
          </Button>
        </div>

        {/* Configuration du rappel */}
        <div className="space-y-3 pt-4 border-t">
          <Label htmlFor="reminder-select" className="flex items-center gap-2">
          ...
          >
            <SelectTrigger id="reminder-select" className="w-full sm:w-[200px]">
          ...
          <p className="text-xs text-muted-foreground">
            Un rappel s'affichera sur le tableau de bord si vous n'avez pas effectué
            de sauvegarde depuis le délai configuré.
          </p>
        </div>
