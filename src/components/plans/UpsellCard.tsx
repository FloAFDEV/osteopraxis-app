...
export const UpsellCard = ({ feature, className }: UpsellCardProps) => {
	...
	const config = {
		appointments: {
			...
			description:
				"Organisez votre agenda, gérez les rendez-vous et envoyez des rappels automatiques à vos patients.",
			benefits: [
		...
		invoices: {
			...
			description:
				"Créez et gérez vos factures professionnelles en quelques clics, avec export PDF et suivi des paiements.",
			benefits: [
		...
		schedule: {
			...
			description:
				"Visualisez votre planning complet de la semaine avec une vue d'ensemble de tous vos rendez-vous.",
			benefits: [
