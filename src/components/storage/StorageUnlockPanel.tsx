    ...
    <Card className="border-orange-200 bg-gradient-to-br from-orange-50 to-amber-50 dark:from-orange-950/30 dark:to-amber-950/30">
      <CardHeader>
        <div className="flex items-center gap-3">
          ...
          <div>
            <CardTitle className="text-xl">Stockage HDS verrouillé</CardTitle>
            <CardDescription>
              Déverrouillez votre stockage local sécurisé pour accéder à vos données médicales
            </CardDescription>
          </div>
        </div>
      </CardHeader>
      ...
      <CardContent className="space-y-4">
        ...
        <div className="space-y-2">
          <Label htmlFor="unlock-password">Mot de passe de déchiffrement</Label>
          <Input
            id="unlock-password"
            type="password"
            value={password}
          ...
          <p className="text-xs text-muted-foreground">
            Saisissez le mot de passe que vous avez défini lors de la configuration initiale
          </p>
        </div>
        ...
        >
          ...
          {attempting ? 'Déverrouillage...' : 'Déverrouiller le stockage HDS'}
        </Button>

        <Alert>
          <AlertCircle className="h-4 w-4" />
          <AlertDescription className="text-xs">
            <strong>Sécurité :</strong> Votre mot de passe n'est jamais stocké. 
            Il est utilisé uniquement pour déchiffrer vos données localement.
          </AlertDescription>
        </Alert>
      </CardContent>
    </Card>
