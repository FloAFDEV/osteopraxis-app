...
import { AlertTriangle, Download, CheckCircle, Shield, FileWarning } from 'lucide-react';
    ...
    <Dialog open={isOpen} onOpenChange={() => {}}>
      ...
      >
        <DialogHeader>
          ...
          <DialogDescription>
            Cette sauvegarde est votre assurance en cas d'oubli du mot de passe
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="space-y-6">
          ...
          <Alert className="border-red-200 bg-red-50 dark:border-red-800 dark:bg-red-950/30">
            ...
            <AlertDescription className="text-red-800 dark:text-red-200">
              <p className="font-bold text-base mb-2">⚠️ Sans cette sauvegarde :</p>
              <ul className="space-y-1 text-sm">
                <li>• Mot de passe oublié = <strong>PERTE TOTALE</strong> de vos données</li>
                <li>• Aucune récupération possible</li>
                <li>• Patients, rendez-vous, factures : tout sera inaccessible</li>
              </ul>
            </AlertDescription>
          </Alert>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-muted-foreground text-sm mb-4">
                      Un fichier <code className="bg-muted px-1 rounded">.phds</code> chiffré sera téléchargé. 
                      Conservez-le dans un endroit sûr (clé USB, cloud personnel, gestionnaire de mots de passe).
                    </p>
                    <Button 
              ...
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-green-600 dark:text-green-400">
                    Votre fichier .phds a été téléchargé. Conservez-le précieusement dans un endroit sûr.
                  </p>
                </div>
              </div>
            </Card>
          ...
          <Alert>
            ...
            <AlertDescription>
              <p className="font-medium mb-2">💡 À propos de ce fichier .phds :</p>
              <ul className="space-y-1 text-sm">
                <li>• <strong>Chiffré</strong> avec votre mot de passe</li>
                <li>• Contient toutes vos données HDS actuelles</li>
                <li>• Permet la récupération en cas d'oubli du mot de passe</li>
                <li>• À conserver dans un endroit sécurisé (clé USB, cloud privé, etc.)</li>
              </ul>
            </AlertDescription>
          </Alert>
          ...
          <div className="text-xs text-center text-muted-foreground space-y-1">
            <p>📋 Recommandation : Créez une nouvelle sauvegarde chaque mois</p>
            <p>🔒 Ce fichier est votre seul moyen de récupération en cas de problème</p>
          </div>
        </div>
      </DialogContent>
    </Dialog>
