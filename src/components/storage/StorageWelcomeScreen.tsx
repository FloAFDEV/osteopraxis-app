				...
				<CardContent className="space-y-6">
						...
						<Alert className="border-green-200 bg-green-50 dark:border-green-800 dark:bg-green-950/30">
							...
							<AlertDescription className="text-green-800 dark:text-green-200">
								...
								<p className="text-sm">
									...
									, configurez maintenant un stockage local
									sécurisé. Configuration rapide :{" "}
						...
						<Card className="border-2 border-green-200 bg-gradient-to-br from-green-50 to-background dark:from-green-950/20 dark:to-background">
							...
							<CardContent className="space-y-2.5 text-sm">
								<div className="flex items-start gap-2">
									...
									<span>
										<strong>100% local</strong> - Aucune
								...
								<div className="flex items-start gap-2">
									<CheckCircle className="w-4 h-4 text-green-600 mt-0.5 shrink-0" />
									<span>
										Chiffrement <strong>AES-256-GCM</strong>{" "}
										militaire
									</span>
								</div>
								<div className="flex items-start gap-2">
									<CheckCircle className="w-4 h-4 text-green-600 mt-0.5 shrink-0" />
									<span>
										<strong>Conformité HDS</strong> complète
									</span>
								</div>
								<div className="flex items-start gap-2">
									<CheckCircle className="w-4 h-4 text-green-600 mt-0.5 shrink-0" />
									<span>
										Protection{" "}
										<strong>anti-falsification</strong> HMAC
									</span>
								</div>
								<div className="flex items-start gap-2">
									<CheckCircle className="w-4 h-4 text-green-600 mt-0.5 shrink-0" />
						...
						<Card className="border-2 border-orange-200 bg-gradient-to-br from-orange-50 to-background dark:from-orange-950/20 dark:to-background">
							...
							<CardContent className="space-y-2.5 text-sm">
								...
								<div className="flex items-start gap-2">
									<X className="w-4 h-4 text-orange-600 mt-0.5 shrink-0" />
									<span>
										<strong>Patients et rendez-vous</strong>{" "}
										non disponibles
									</span>
								</div>
								<div className="flex items-start gap-2">
								...
								<div className="flex items-start gap-2">
									<CheckCircle className="w-4 h-4 text-green-600 mt-0.5 shrink-0" />
									<span>
										Configuration possible plus tard
									</span>
								</div>
							</CardContent>
						</Card>
					...
					<div className="bg-muted/50 p-4 rounded-lg space-y-2">
						...
						<ul className="text-sm space-y-1.5 ml-6">
							...
							<li>
								• Vous créerez un{" "}
								<strong>mot de passe unique</strong> pour
								chiffrer vos données
							</li>
							<li>
								•{" "}
								<strong className="text-destructive">
									Ce mot de passe est irremplaçable
								</strong>{" "}
								- conservez-le précieusement
							</li>
							<li>
								• <strong>Export/import</strong> de vos données
