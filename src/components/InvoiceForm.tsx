...
export function InvoiceForm({
	...
	const onSubmit = async (data: any) => {
		...
		try {
			...
			toast.error(
				"Erreur lors de l'enregistrement de la note d'honoraires.",
			);
			console.error(e);
		}
	...
	return (
		<form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
			<h2 className="text-lg font-semibold mb-2">Note d'honoraires</h2>
			{/* Émetteur (ostéopathe) */}
			<InvoiceOsteopathInput
			...
			<div>
				<Label htmlFor="notes-input" className="block text-sm mb-1">
					Notes complémentaires
				</Label>
				<Textarea
					id="notes-input"
