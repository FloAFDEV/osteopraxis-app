...
export const DemoIndicator = ({ className = "", showCTA = true }: DemoIndicatorProps) => {
  ...
  return (
    <div className={`bg-purple-50 dark:bg-purple-950/30 border border-purple-200 dark:border-purple-700/50 rounded-lg p-4 ${className}`}>
      <div className="flex items-start justify-between gap-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            <div className="flex items-center gap-2 mb-1">
              <Badge variant="outline" className="bg-purple-100 dark:bg-purple-800/50 text-purple-700 dark:text-purple-200 border-purple-300 dark:border-purple-600/50">
                MODE DÉMO
              </Badge>
            </div>
        ...
        {showCTA && (
          <div className="flex flex-col gap-2 ml-auto">
            ...
            <p className="text-xs text-purple-600 dark:text-purple-300 text-center">
