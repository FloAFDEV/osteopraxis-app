...
const demoSteps: GuideStep[] = [
	{
		...
		description:
			"Créez et consultez des dossiers patients complets avec historique médical",
	...
	},
	{
		...
		description:
			"Organisez vos rendez-vous et suivez leur statut en temps réel",
	...
	},
	{
		...
		description:
			"Visualisez votre agenda en vue journalière, hebdomadaire ou mensuelle",
		icon: <Calendar className="h-5 w-5" />,
		path: "/schedule",
	},
	{
					...
					<div className="flex items-center gap-3">
						...
						<div>
							...
							<p className="text-sm text-cyan-700 dark:text-cyan-200">
								Explorez toutes les fonctionnalités avec des
								données de test
							</p>
						</div>
					</div>
								...
								<CardContent className="p-4">
									<div className="flex items-start justify-between mb-3">
										...
										{step.badge && (
											<Badge
												variant="secondary"
												className="text-sm bg-cyan-100 text-cyan-700 dark:bg-cyan-900/50 dark:text-cyan-200"
											>
												{step.badge}
											</Badge>
										)}
									...
									<p className="text-sm text-cyan-600 mb-3 line-clamp-2 dark:text-cyan-300">
										{step.description}
									</p>
