...
export interface ConsultationTemplate {
	...
	name: string;
	description?: string | null;
	category: 'general' | 'pediatric' | 'sport' | 'chronic' | 'preventive';
	content: {
		sections: {
			[key: string]: {
				title: string;
...
export interface CreateConsultationTemplatePayload {
	name: string;
	description?: string | null;
	category: 'general' | 'pediatric' | 'sport' | 'chronic' | 'preventive';
	content: ConsultationTemplate['content'];
	isActive?: boolean;
	osteopathId: number;
	cabinetId?: number | null;
}
...
export interface CalendarEvent {
	...
	extendedProps?: {
		...
		patient?: Patient;
		type: 'appointment' | 'google' | 'recurring';
...
export interface DragDropResult {
	draggedId: string;
	draggedType: 'appointment' | 'recurring';
	newStart: Date;
	newEnd: Date;
	resourceId?: string;
}
