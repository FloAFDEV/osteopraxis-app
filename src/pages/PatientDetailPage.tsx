    ...
    <div className="flex flex-col space-y-6 max-w-6xl mx-auto px-4">
      ...
      <div className="border-b border-gray-200 dark:border-gray-700 pb-6 mb-6">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6">
          ...
          <PatientStat
            ...
            value={
              pastAppointments[0]
                ? format(new Date(pastAppointments[0].date), "dd/MM/yyyy")
                : "Aucun"
            }
      ...
      <div className="border-b border-gray-200 dark:border-gray-700 pb-6 mb-6">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 rounded-lg bg-white dark:bg-gray-900 shadow p-6">
            <Tabs defaultValue="medical-info">
              ...
              <TabsContent value="upcoming-appointments" className="mt-6 space-y-4">
                {upcomingAppointments.length === 0 ? (
                  <div className="text-center py-8">
                    <Calendar className="h-10 w-10 text-muted-foreground mx-auto mb-3" />
                    <h3 className="text-xl font-medium">Aucun rendez-vous à venir</h3>
                    <p className="text-muted-foreground mt-2">
                      Ce patient n'a pas de rendez-vous planifiés.
                    </p>
