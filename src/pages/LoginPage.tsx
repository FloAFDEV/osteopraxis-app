...
const LoginPage = () => {
  ...
  return <div className="min-h-screen flex">
      ...
      <div className="w-full lg:w-1/2 flex flex-col justify-between p-8 md:p-12 bg-[#0d1117]">
        <div className="mb-6">
          <h1 className="text-3xl md:text-4xl font-bold bg-clip-text text-transparent bg-gradient-to-r \nfrom-blue-500 via-purple-500 to-pink-500 \ndark:from-blue-500 dark:via-purple-500 dark:to-purple-500 whitespace-pre">
            PatientHub
          </h1>
        </div>
