          ...
          <div className="w-full max-w-md space-y-8">
            ...
            <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
              <TabsList className="grid grid-cols-2 mb-6 bg-gray-900">
                <TabsTrigger value="password" className="bg-gray-600 hover:bg-gray-500 text-stone-200">Mot de passe</TabsTrigger>
                <TabsTrigger value="magiclink" className="text-stone-100 bg-gray-600 hover:bg-gray-500">Magic Link</TabsTrigger>
              </TabsList>
