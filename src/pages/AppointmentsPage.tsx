...
const AppointmentsPage = () => {
	...
	const groupAppointmentsByMonthAndDay = (
		...
		apps.forEach((appointment) => {
			...
			if (!dateString) {
				console.warn(
					"⚠️ Appointment sans date dans groupBy:",
					appointment,
				);
				return;
			}
									...
									<div className="mb-8">
										...
										>
											<div className="flex items-center gap-3">
												...
												<span className="inline-flex items-center justify-center px-2 py-0.5 text-sm font-bold leading-none text-green-100 bg-green-600 dark:bg-green-700 rounded-full">
									...
									<div className="mb-8">
										...
										>
											<div className="flex items-center gap-3">
												...
												<span className="inline-flex items-center justify-center px-2 py-0.5 text-sm font-bold leading-none text-blue-100 bg-blue-600 dark:bg-blue-700 rounded-full">
									...
									<div className="mb-8">
										...
										>
											<div className="flex items-center gap-3">
												...
												<span className="inline-flex items-center justify-center px-2 py-0.5 text-sm font-bold leading-none text-gray-100 bg-gray-500 dark:bg-gray-700 rounded-full">
