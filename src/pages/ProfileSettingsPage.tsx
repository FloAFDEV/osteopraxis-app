	...
	useEffect(() => {
		const checkMode = async () => {
			...
			if (demo) {
				...
				console.log(
					"🔍 [ProfileSettings] Demo cabinet ID:",
					demoCabinetId,
				);

				if (demoCabinetId) {
					const osteopath =
						demoLocalStorage(demoCabinetId).getOsteopath();
					const cabinets =
						demoLocalStorage(demoCabinetId).getCabinets();

					console.log(
						"👤 [ProfileSettings] Osteopath loaded:",
						osteopath,
					);
					console.log(
						"🏢 [ProfileSettings] Cabinets loaded:",
						cabinets,
					);
					...
					console.warn(
						"⚠️ [ProfileSettings] No demo_cabinet_id found in localStorage",
					);
				}
			}
			...
			<div className="max-w-4xl mx-auto space-y-6">
				...
				<div className="flex items-center justify-between">
					<div>
						...
						<p className="text-muted-foreground mt-1">
							Gérez vos informations professionnelles et votre
							cabinet principal
						</p>
					</div>
					{isDemo && (
				...
				{isDemo && (
					<Alert className="border-blue-200 bg-blue-50">
						...
						<AlertDescription className="text-blue-900">
							<strong>Mode Démo :</strong> Ces informations sont
							fictives et en lecture seule. Inscrivez-vous pour
							gérer votre vrai cabinet et générer des factures
							personnalisées.
						</AlertDescription>
					</Alert>
				)}
						...
						<div className="grid gap-4 md:grid-cols-2">
							...
							<div className="space-y-2">
								...
								<Input
									id="title"
									value={
										demoOsteopath?.professional_title || ""
									}
									disabled={isDemo}
							...
							<div className="grid gap-4 md:grid-cols-2">
								<div className="space-y-2">
									...
									<p className="text-sm text-muted-foreground">
										11 chiffres - Numéro d'identification
										RPPS
									</p>
								</div>
								...
								<div className="space-y-2">
									...
									/>
									<p className="text-sm text-muted-foreground">
										14 chiffres - Numéro SIRET de votre
										cabinet
									</p>
								</div>
							</div>
				...
				<Card>
					<CardHeader>
						...
						<CardDescription>
							Les informations de votre cabinet apparaîtront sur
							vos factures
						</CardDescription>
					</CardHeader>
					<CardContent className="space-y-4">
