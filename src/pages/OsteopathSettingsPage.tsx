...
const OsteopathSettingsPage = () => {
  ...
  // Log the rendering state
  console.log("Rendering OsteopathSettingsPage:", {
    hasUser: !!user,
      ...
      <div className="max-w-3xl mx-auto">
        <div className="mb-6">
          <h1 className="text-3xl font-bold flex items-center gap-2">
            ...
            {osteopath ? "Modifier mon profil professionnel" : "Créer mon profil professionnel"}
          </h1>
          ...
          {osteopath ? (
            ...
            <div className="py-6">
              <p className="text-muted-foreground mb-4">
                Créez votre profil professionnel pour commencer à utiliser l'application.
              </p>
              <OsteopathProfileForm 
                onSuccess={handleSuccess} 
                defaultValues={{
