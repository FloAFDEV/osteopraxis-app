...
const InvoiceDetailPage = () => {
  ...
  return <Layout>
			<div className="max-w-4xl mx-auto py-6">
				...
				{invoice && <>
						<div className="mb-6">
							<InvoicePrintView invoice={invoice} patient={patient || undefined} osteopath={osteopath || undefined} cabinet={cabinet || undefined} />
						</div>

						<div className="hidden">
							<div ref={printRef}>
								<InvoicePrintView invoice={invoice} patient={patient} osteopath={osteopath} cabinet={cabinet} />
							</div>
						</div>
					</>}
			</div>
