...
const RegisterPostPaymentPage = () => {
  ...
  useEffect(() => {
    ...
    if (!sessionId) {
      toast.error("Aucun paiement validé. Redirection vers la page de paiement.");
      navigate('/pricing');
      return;
    }
        ...
        <div className="container mx-auto px-4 max-w-md">
          ...
          <div className="text-center mb-8">
            <div className="inline-flex items-center gap-2 bg-green-100 dark:bg-green-900/30 text-green-700 dark:text-green-300 px-4 py-2 rounded-full mb-4">
              ...
              <span className="font-semibold">Paiement validé</span>
            </div>
            <h1 className="text-4xl font-bold mb-2">Finalisez votre compte</h1>
          ...
          <Card>
            ...
            <CardContent>
              ...
              <div className="mt-6 text-center text-sm text-muted-foreground flex items-center justify-center gap-2">
                ...
                <span>Vos données sont sécurisées et conformes HDS</span>
              </div>
            </CardContent>
          </Card>
