              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between mb-4">
                  ...
                  <h2 className="text-xl font-medium">
                    Semaine du {format(currentWeek[0], "d MMMM", { locale: fr })} au {format(currentWeek[6], "d MMMM yyyy", { locale: fr })}
                  </h2>
...
const DaySchedule = ({ date, appointments, getPatientById }: DayScheduleProps) => {
