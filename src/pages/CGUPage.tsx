        ...
        <div className="space-y-8">
          ...
          <section className="bg-card rounded-lg border p-6">
            ...
            <div className="space-y-3 text-muted-foreground">
              <p>
                ...
                du logiciel <strong>OstéoPraxis</strong>.
              </p>
              <p>
                OstéoPraxis est un <strong>outil de gestion local</strong> destiné aux professionnels
                de santé, fourni <strong>en l'état</strong>, sans garantie de service continu.
              </p>
              <p>
          ...
          <section className="bg-card rounded-lg border p-6">
            ...
            <div className="space-y-3 text-muted-foreground">
              ...
              <ul className="list-disc list-inside ml-4 space-y-2">
                <li><strong>Mode démo gratuit</strong> : Accès temporaire pour découvrir les fonctionnalités</li>
                <li><strong>Mode inscrit</strong> : Accès complet après création d'un compte</li>
              </ul>
              <p className="mt-4">
                L'accès au logiciel est fourni <strong>sans engagement</strong>.
                Le paiement unique de 49€ à vie n'est pas obligatoire pour utiliser les fonctionnalités de base.
              </p>
              <div className="bg-blue-50 dark:bg-blue-950/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4 mt-4">
                <p className="text-blue-800 dark:text-blue-200">
                  L'accès au logiciel peut être interrompu volontairement par l'utilisateur à tout moment.
                </p>
              </div>
            </div>
          </section>
          ...
          <section className="bg-card rounded-lg border p-6 border-amber-300 dark:border-amber-700">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h2 className="text-xl font-semibold">3. Données & Stockage</h2>
            ...
            <div className="space-y-4 text-muted-foreground">
              <div className="bg-amber-50 dark:bg-amber-950/30 border border-amber-200 dark:border-amber-700 rounded-lg p-4">
                ...
                <p className="text-amber-800 dark:text-amber-200">
                  Toutes vos données métier (patients, dossiers, factures) sont stockées dans
                  la base IndexedDB de votre navigateur, sur votre appareil uniquement.
                </p>
              </div>
              ...
              <div className="bg-red-50 dark:bg-red-950/20 border border-red-200 dark:border-red-800 rounded-lg p-4">
                ...
                <ul className="list-disc list-inside space-y-1 text-red-700 dark:text-red-300">
                  <li>N'a <strong>aucun accès</strong> à vos données</li>
                  <li>Ne peut <strong>ni les consulter, ni les restaurer</strong></li>
                  <li>Ne peut être tenu responsable de leur perte</li>
                </ul>
              </div>

              <div className="bg-slate-50 dark:bg-slate-950/30 border border-slate-200 dark:border-slate-700 rounded-lg p-4">
                <p className="font-medium text-slate-800 dark:text-slate-200">
                  L'utilisateur reconnaît avoir été informé que la sauvegarde des données
                  relève <strong>exclusivement de sa responsabilité</strong>.
                </p>
              </div>
            </div>
          </section>
          ...
          <section className="bg-card rounded-lg border p-6">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h2 className="text-xl font-semibold">4. Sauvegardes</h2>
            </div>
            <div className="space-y-3 text-muted-foreground">
              <p>Le logiciel propose :</p>
              <ul className="list-disc list-inside ml-4 space-y-2">
                <li>Une fonctionnalité de <strong>sauvegarde manuelle</strong> (export des données)</li>
                <li>Des <strong>rappels de sauvegarde</strong> configurables (7, 14 ou 30 jours)</li>
              </ul>
              <p className="mt-4">
                <strong>Aucune sauvegarde automatique distante</strong> n'est effectuée.
              </p>
              <div className="bg-amber-50 dark:bg-amber-950/20 border border-amber-200 dark:border-amber-800 rounded-lg p-4 mt-4">
                <p className="text-amber-800 dark:text-amber-200">
                  <strong>L'absence de sauvegarde régulière ne saurait être reprochée à l'éditeur.</strong>
                </p>
              </div>
            </div>
          </section>
          ...
          <section className="bg-card rounded-lg border p-6">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h2 className="text-xl font-semibold">5. Suppression des données</h2>
            </div>
            <div className="space-y-3 text-muted-foreground">
              <p>La suppression des données s'effectue :</p>
              <ul className="list-disc list-inside ml-4 space-y-2">
                <li>Par action volontaire de l'utilisateur</li>
                <li>Avec protection par code de confirmation à 4 chiffres</li>
                <li>De manière <strong>définitive et irréversible</strong></li>
              </ul>
              <div className="bg-red-50 dark:bg-red-950/20 border border-red-200 dark:border-red-800 rounded-lg p-4 mt-4">
                <p className="font-medium text-red-800 dark:text-red-200">
                  Toute suppression validée est définitive et ne pourra donner lieu à aucune récupération.
                </p>
              </div>
            </div>
          </section>
          ...
          <section className="bg-card rounded-lg border p-6">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h2 className="text-xl font-semibold">6. Responsabilité médicale et légale</h2>
            </div>
            <div className="space-y-3 text-muted-foreground">
              <div className="bg-purple-50 dark:bg-purple-950/20 border border-purple-200 dark:border-purple-800 rounded-lg p-4">
                ...
                <ul className="list-disc list-inside space-y-1 text-purple-700 dark:text-purple-300 mt-2">
                  ...
                  <li>Les obligations légales et réglementaires de la profession</li>
                  <li>Les outils de facturation certifiés si requis par la loi</li>
                </ul>
              </div>
            </div>
          </section>
            ...
            <div className="space-y-4 text-muted-foreground">
              <div className="bg-red-50 dark:bg-red-950/20 border border-red-200 dark:border-red-800 rounded-lg p-4">
                <p className="font-bold text-red-800 dark:text-red-200 mb-2">
                  La responsabilité de l'éditeur est strictement limitée au montant effectivement
                  payé par l'utilisateur pour l'accès au logiciel.
                </p>
                <p className="text-red-700 dark:text-red-300 text-sm">
                  En cas de paiement de 49€, la responsabilité maximale de l'éditeur est limitée à 49€.
                </p>
              </div>
              <p>
                L'éditeur ne pourra en aucun cas être tenu responsable des dommages indirects,
                pertes de données, pertes d'exploitation, ou préjudices de quelque nature que ce soit.
              </p>
            </div>
          </section>
          ...
          <section className="bg-card rounded-lg border p-6">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h2 className="text-xl font-semibold">8. Évolution du logiciel</h2>
            </div>
            <div className="space-y-3 text-muted-foreground">
              <p>Le logiciel peut évoluer à tout moment :</p>
              <ul className="list-disc list-inside ml-4 space-y-2">
                <li>Ajout de nouvelles fonctionnalités</li>
                <li>Modification de fonctionnalités existantes</li>
                <li>Corrections de bugs</li>
              </ul>
              <p className="mt-4">
                L'éditeur n'a <strong>aucune obligation de maintien</strong> d'une version donnée
                du logiciel.
              </p>
            </div>
          </section>
          ...
          <section className="bg-card rounded-lg border p-6">
            ...
            <div className="space-y-3 text-muted-foreground">
              ...
              <p>
                ...
                les tribunaux du ressort du siège social de l'éditeur seront seuls compétents.
              </p>
            </div>
          </section>
          ...
          <section className="bg-indigo-50 dark:bg-indigo-950/30 rounded-lg border border-indigo-200 dark:border-indigo-700 p-6 text-center">
            <p className="text-indigo-800 dark:text-indigo-200 font-medium">
              En utilisant OstéoPraxis, vous acceptez les présentes Conditions Générales d'Utilisation.
            </p>
          </section>
