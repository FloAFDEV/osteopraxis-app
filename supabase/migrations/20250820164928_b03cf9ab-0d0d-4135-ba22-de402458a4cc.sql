...
-- Fonction pour marquer une session comme nettoyée
CREATE OR REPLACE FUNCTION mark_demo_session_cleaned(session_uuid UUID)
RETURNS VOID AS $$
BEGIN
...
-- Programmer un nettoyage automatique toutes les 10 minutes
