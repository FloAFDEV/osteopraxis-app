...
DROP FUNCTION IF EXISTS public.admin_find_patient_duplicates();
DROP FUNCTION IF EXISTS public.admin_deactivate_cabinet(integer);
DROP FUNCTION IF EXISTS public.admin_cleanup_old_logs(integer);

-- Recréer admin_get_system_stats avec les bons types
