-- Correction finale de la fonction admin_get_cabinets_with_stats
-- Le problème est que la table Cabinet utilise timestamp without time zone
-- mais la fonction retourne timestamp with time zone
